...
gear.adhemar_acc_head = {name="Adhemar Bonnet +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
gear.adhemar_att_head = {name="Adhemar Bonnet +1", augments={'STR+12','DEX+12','Attack+20',}}
gear.adhemar_acc_body = {name="Adhemar Jacket +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
gear.adhemar_att_body = {name="Adhemar Jacket +1", augments={'STR+12','DEX+12','Attack+20',}}
gear.adhemar_fc_body  = {name="Adhemar Jacket +1", augments={'HP+105','"Fast Cast"+10','Magic dmg. taken -4',}}
gear.adhemar_acc_hands = {name="Adhemar Wrist. +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
gear.adhemar_att_hands = {name="Adhemar Wrist. +1", augments={'STR+12','DEX+12','Attack+20',}}
gear.adhemar_att_feet = {name="Adhe. Gamashes. +1", augments={'STR+12','DEX+12','Attack+20',}}

gear.lustratio_crit_legs = { name="Lustr. Subligar +1", augments={'Accuracy+20','DEX+8','Crit. hit rate+3%',}}
...
gear.herculean_mab_legs = {name="Herculean Trousers", augments={'"Mag.Atk.Bns."+18','Weapon skill damage +4%','STR+9',}}
gear.herculean_crit_feet = {name="Herculean Boots",augments={'Accuracy+4 Attack+4','Accuracy+10','Crit. hit damage +1%'}}
gear.herculean_mab_feet = {name="Herculean Boots", augments={'"Mag.Atk.Bns."+24','Weapon skill damage +5%','Mag. Acc.+15',}}
...
gear.rao_att_legs = {name="Rao Haidate +1", augments={'STR+12','DEX+12','Attack+20',}}

gear.ryuo_stp_head = {name="Ryuo Somen +1", augments={'STR+12','DEX+12','Accuracy+20',}}
gear.ryuo_da_hands = {name="Ryuo Tekko +1", augments={'DEX+12','Accuracy+25','"Dbl.Atk."+4'}}
gear.ryuo_stp_legs = { name="Ryuo Hakama +1", augments={'Accuracy+25','"Store TP"+5','Phys. dmg. taken-4%',}}
gear.ryuo_stp_feet = { name="Ryuo Sune-Ate +1", augments={'HP+65','"Store TP"+5','"Subtle Blow"+8',}}
