...
function user_job_setup()
    ...
    gear.fc_jse_back = {name="Alaunus's Cape", augments={'"Fast Cast"+10',}}
    gear.healing_jse_back = {name="Alaunus's Cape", augments={'MND+20','Mag. Acc+10 /Mag. Dmg.+10','MND+5','Enmity-10',}}
